...
global.webpackJsonpMpvue([10],{
  "5vTQ":function(t,s,a){
    "use strict";var e=a("Dd8w"),n=a.n(e),i=a("NYxO"),o=a("0xDb");s.a={data:function(){return{modalVisible:!1,conversation:{}}},computed:n()({},Object(i.c)({
    allConversation:function(t){
      console.log(t)
      console.log("是不是这里？？")
      console.log("index:"+app.globalData.youke)
  ...
  onShow:function(){
    if(app.globalData.youke==0){
      console.log("index-onshow:"+app.globalData.youke)
      wx.setTabBarItem({
        index: 0,
        text: '消息',
        iconPath: "static/theme/chat.png",
